 ...
 * Purpose: MicroProjet, formatted output generation library
 * Authors: (c) R.Holzer (adapted MICRO210/EE208 A.Schmid)
 * Misc: v2019.02 20180821 AxS supports SRAM input from through 0x02ff that should be reserved
 */ 
